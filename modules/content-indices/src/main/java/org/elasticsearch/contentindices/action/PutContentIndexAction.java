...
public class PutContentIndexAction extends ActionType<AcknowledgedResponse> {

    public static final PutContentIndexAction INSTANCE = new PutContentIndexAction();
    public static final String NAME = "indices:admin/content_index/put";

    private PutContentIndexAction() {
