 ...
 */
public class DenseVectorEmbeddingOperatorRequestIterator implements BulkInferenceRequestIterator {
    private final BytesRefBlock inputBlock;
    private final String inferenceId;
    private final int batchSize;
    private int remainingPositions;

    public DenseVectorEmbeddingOperatorRequestIterator(BytesRefBlock inputBlock, String inferenceId, int batchSize) {
