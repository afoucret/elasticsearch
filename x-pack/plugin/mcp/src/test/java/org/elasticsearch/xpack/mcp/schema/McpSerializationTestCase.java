...
import org.elasticsearch.xpack.mcp.schema.content.McpContent;
...
import org.elasticsearch.xpack.mcp.schema.core.McpCancelledNotification;
...
import org.elasticsearch.xpack.mcp.schema.elicitation.McpElicitResultAction;
...
import org.elasticsearch.xpack.mcp.schema.logging.McpLoggingLevel;
...
import org.elasticsearch.xpack.mcp.schema.sampling.McpIncludeContext;
import org.elasticsearch.xpack.mcp.schema.sampling.McpSamplingMessage;
import org.elasticsearch.xpack.mcp.schema.sampling.McpStopReason;
...
public abstract class McpSerializationTestCase<T extends NamedWriteable & ToXContentObject> extends AbstractXContentSerializingTestCase<T> {
    ...
    protected NamedWriteableRegistry getNamedWriteableRegistry() {
        return new NamedWriteableRegistry(McpSchema.namedWriteables());
    }
}
