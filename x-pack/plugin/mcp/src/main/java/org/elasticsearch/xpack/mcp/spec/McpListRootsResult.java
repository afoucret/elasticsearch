...
public record McpListRootsResult(List<McpResource> roots, String nextCursor, Map<String, Object> meta) implements McpResult {
    ...
    static {
        PARSER.declareObjectArray(constructorArg(), (p, c) -> McpResource.PARSER.parse(p, null), ROOTS);
