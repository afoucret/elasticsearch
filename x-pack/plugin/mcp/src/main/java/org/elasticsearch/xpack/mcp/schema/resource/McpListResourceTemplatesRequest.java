...
public record McpListResourceTemplatesRequest(String cursor, Map<String, Object> meta) implements McpClientRequest {

    public static final String NAME = "mcp_list_resource_templates_request";
    ...
    public static final ConstructingObjectParser<McpListResourceTemplatesRequest, Object> PARSER = new ConstructingObjectParser<>(
        NAME,
        args -> new McpListResourceTemplatesRequest((String) args[0], (Map<String, Object>) args[1])
    );
    ...
    public McpListResourceTemplatesRequest(StreamInput in) throws IOException {
