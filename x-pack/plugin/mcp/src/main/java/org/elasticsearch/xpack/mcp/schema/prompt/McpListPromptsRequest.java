...
public record McpListPromptsRequest(String cursor, Map<String, Object> meta) implements McpClientRequest {
    ...
    public static final Entry NAMED_WRITEABLE_ENTRY = new Entry(
        ...
        McpListPromptsRequest.NAME,
        McpListPromptsRequest::new
    );
    ...
    public static final ConstructingObjectParser<McpListPromptsRequest, Object> PARSER = new ConstructingObjectParser<>(
        NAME,
