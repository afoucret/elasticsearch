...
import org.elasticsearch.xpack.mcp.schema.core.McpClientResult;
...
public record McpCompleteResult(@NotNull Completion completion, Map<String, Object> meta) implements McpServerResult, McpClientResult {
