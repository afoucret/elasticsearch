 ...
 * 2.0.
 */
package org.elasticsearch.xpack.mcp.schema.jsonrpc;
...
public record JSONRPCResponse(@NotNull String jsonrpc, @NotNull Object id, Map<String, Object> result, JSONRPCError error)
    implements
        JSONRPCMessage {
